...
/* ── Data ─────────────────────────────────────────────────── */
const PHOTO_FILTERS = ["All", "Maternal Care", "Scholarships", "Elderly Care", "Events", "Team"];

const FILTER_DESCRIPTORS = {
  "All":          "Every photograph JOAM has published — field work, events, team, and community.",
  "Maternal Care":"Images from our maternal healthcare programme — clinic days, community outreach, and the mothers at the centre of everything we do.",
  "Scholarships": "Our scholars — in classrooms, at award ceremonies, and in the communities they are going to change.",
  "Elderly Care": "The elders we serve. Their faces, their homes, their dignity. This programme exists because someone looked and did not look away.",
  "Events":       "Fundraisers, awareness days, community gatherings, and the moments that bring JOAM's supporters together.",
...
const PHOTOS = [
  { category: "Maternal Care",  caption: "Maternal Care · Ekiti State — A midwife conducts a prenatal check during JOAM's first community health day.",         span: "col-span-2 row-span-2" },
  { category: "Scholarships",   caption: "Scholarships · [State] — A scholarship recipient at the award ceremony.",                                               span: "" },
  { category: "Elderly Care",   caption: "Elderly Care · [State] — Volunteers deliver food provisions to an elderly beneficiary.",                                 span: "" },
  { category: "Team",           caption: "Team · [Location] — JOAM field staff preparing for a community outreach day.",                                          span: "" },
  { category: "Events",         caption: "Events · [City] — Community members gather for JOAM's first public awareness event.",                                    span: "" },
  { category: "Maternal Care",  caption: "Maternal Care · [State] — Mothers at the postnatal support circle.",                                                    span: "" },
  { category: "Scholarships",   caption: "Scholarships · [City] — Students receiving their first scholarship letters.",                                            span: "" },
  { category: "Elderly Care",   caption: "Elderly Care · [State] — A healthcare check conducted in a beneficiary's home.",                                        span: "" },
  { category: "Team",           caption: "Team · [Location] — Volunteers at the end of a community outreach day.",                                                span: "" },
];
          ...
          <>
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="grid grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-3 auto-rows-[180px]"
              >
                {photos.map((photo, i) => (
                  <PhotoTile
                    key={i}
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 left-3 z-10">
        <span className="font-body text-[9px] font-semibold tracking-[0.1em] uppercase
  ...
  return (
    ...
    >
      ...
      <p className="font-body text-[14px] leading-[1.75] text-ink-secondary max-w-[400px] mx-auto mb-6">
        The JOAM Foundation has just launched. Our field teams are in communities,
        our programmes are beginning, and our first photographs will be published
...
function Lightbox({ photo, onClose }) {
  return (
    ...
    >
      ...
      >
        {/* Image */}
        <div className="w-full aspect-[4/3] bg-primary-mid border border-cream-surface/[0.06]
      ...
      <div className="max-w-container mx-auto">
        ...
        <motion.div {...fadeUp(0)} className="mb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-1 gap-10 md:gap-4 items-end">
            ...
            <p className="font-body text-[14px] leading-[1.75] text-ink-secondary md:hidden">
              ...
              beneficiaries are willing to speak, we listen and we record.
              These are their stories — unscripted, unedited, and entirely real.
            </p>
          </div>
        </motion.div>
        ...
        >
          <p className="font-body text-[13px] text-ink-muted text-center">
            ...
            showing this work on camera — not because it makes good content,
            but because it makes our accountability visible.{" "}
            <a href="/blog" className="text-primary no-underline border-b border-primary/30
        ...
        <div className="grid grid-cols-3 md:grid-cols-1 gap-5">
          {VIDEOS.map((video, i) => (
            ...
            >
              {/* Thumbnail */}
              <div className="w-full h-[160px] bg-primary-light relative
                flex items-center justify-center">
                <div className="flex flex-col items-center gap-2">
                  {/* Play button */}
                  <div className="w-12 h-12 rounded-full bg-primary/80 border border-accent/30
                ...
                <div className="absolute bottom-3 right-3">
                  <span className="font-body text-[10px] text-cream-surface/40 bg-primary/50
              ...
              {/* Content */}
              <div className="p-5">
                <h3 className="font-display font-bold text-ink text-[16px] leading-[1.3] mb-2
                ...
                <span className="font-body text-[11px] font-semibold tracking-[0.08em] uppercase
  ...
  return (
    ...
    >
      <div className="max-w-container mx-auto">
        ...
        <motion.div {...fadeUp(0)} className="mb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-1 gap-10 md:gap-4 items-end">
            ...
            <p className="font-body text-[14px] leading-[1.75] text-ink-secondary md:hidden">
              ...
              coverage, and mentions of the JOAM Foundation in press and
              public discourse.
            </p>
          </div>
        </motion.div>
        ...
        <motion.div
          {...fadeUp(0.1)}
          className="grid grid-cols-2 md:grid-cols-1 gap-8 items-start"
        >
          ...
          <div className="p-8 sm:p-6 bg-cream-surface border border-border rounded-[4px]">
            <p className="font-body text-[11px] font-semibold tracking-[0.12em] uppercase
              text-accent mb-5">
              Media Contact
            </p>
            <div className="flex items-center gap-4 mb-5">
              <div className="w-12 h-12 rounded-full bg-primary-light border border-primary/[0.1]
                flex items-center justify-center shrink-0">
                <span className="font-display text-[16px] font-bold text-primary leading-none">J</span>
              </div>
              <div>
      ...
      <div className="max-w-container mx-auto grid grid-cols-2 md:grid-cols-1 gap-14 md:gap-8 items-center">
        ...
        <motion.div {...fadeLeft(0)}>
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <Button variant="ghost-dark" href="#">Share This Page</Button>
          </div>
        </motion.div>
        ...
        <motion.div {...fadeRight(0.1)} className="space-y-4">
          <p className="font-body text-[15px] leading-[1.8] text-cream-surface/58">
            ...
            image we publish — the next mother, the next scholar, the next
            elder — starts with someone choosing to give today.
          </p>
          <p className="font-body text-[15px] leading-[1.8] text-cream-surface/58">
